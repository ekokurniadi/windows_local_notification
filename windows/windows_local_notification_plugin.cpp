#include "include/windows_local_notification/windows_local_notification_plugin.h"
...
class WindowsLocalNotificationPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarWindows* registrar);

  WindowsLocalNotificationPlugin();

  virtual ~WindowsLocalNotificationPlugin();
 ...
 private:
  ...
  HWND WindowsLocalNotificationPlugin::GetMainWindow();
  void WindowsLocalNotificationPlugin::Setup(
      const flutter::MethodCall<flutter::EncodableValue>& method_call,
      std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result);
  void WindowsLocalNotificationPlugin::Notify(
      const flutter::MethodCall<flutter::EncodableValue>& method_call,
      std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result);
  void WindowsLocalNotificationPlugin::Close(
      const flutter::MethodCall<flutter::EncodableValue>& method_call,
      std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result);
...
// static
void WindowsLocalNotificationPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows* registrar) {
  channel = std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
      registrar->messenger(), "windows_local_notification",
      &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<WindowsLocalNotificationPlugin>();
...
WindowsLocalNotificationPlugin::WindowsLocalNotificationPlugin() {}
...
void WindowsLocalNotificationPlugin::Notify(
  ...
  WinToastTemplate::AudioSystemFile::Alarm10;
...
void WindowsLocalNotificationPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue>& method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void WindowsLocalNotificationPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  WindowsLocalNotificationPlugin::RegisterWithRegistrar(
